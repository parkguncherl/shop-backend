...
import com.smart.core.enums.JwtSessionAttribute;
...
public class AccessLogAspect {
    ...
    @AfterReturning(pointcut="execution(* com.smart.api.biz.*.controller.*.*(..)) && @annotation(com.smart.api.annotation.AccessLog)", returning = "result")
//    @Before( "execution(* com.smart.api.biz.*.controller.*.*(..)) && @annotation(com.smart.api.annotation.AccessLog)")
