...
@AllArgsConstructor
@NoArgsConstructor
@Schema(name = "OldStock", description = "입고원장 이력 Entity")
public class OldStock extends BaseEntity implements Serializable {

    @Serial
    private static final long serialVersionUID = 3056713244952224501L;
    ...
    @Schema(description = "반출량")
    private Integer returnCnt;

    @Schema(description = "반출금액")
