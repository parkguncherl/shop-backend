...
@AllArgsConstructor
@NoArgsConstructor
@Schema(name = "OldMisong", description = "미송발송 이력 Entity")
public class OldMisong extends BaseEntity implements Serializable {

    @Serial
    private static final long serialVersionUID = 3056713244999954501L;
    ...
    @Schema(description = "미송수량")
    private Integer misongCnt;

    @Schema(description = "발송수량")
