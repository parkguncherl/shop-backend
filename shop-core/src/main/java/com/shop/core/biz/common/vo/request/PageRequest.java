...
public class PageRequest<T> {
    ...
    @Schema(description = "포커싱되어야 하는 row 번호", required = true)
    @Parameter(description = "포커싱되어야 하는 row 번호")
    protected Integer focusedIndex;
    ...
    /** 검색 일자(YYYY-MM-DD) */
    @Schema(description = "검색 일자")
    @Parameter(description = "검색 일자")
    protected String workYmd;
    ...
    public PageRequest() {
        ...
        this.sortColumn = "id";
        this.sortType = SortTypeCode.DESC.getCode();
        this.filter = null;
    }
