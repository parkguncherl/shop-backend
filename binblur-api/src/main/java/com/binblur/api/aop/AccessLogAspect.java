package com.binblur.api.aop;

import com.binblur.api.annotation.AccessLog;
import com.binblur.api.biz.system.service.ContactService;
...
public class AccessLogAspect {
    ...
    @AfterReturning(pointcut="execution(* com.binblur.api.biz.*.controller.*.*(..)) && @annotation(com.binblur.api.annotation.AccessLog)", returning = "result")
